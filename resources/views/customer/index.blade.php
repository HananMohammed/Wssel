            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('customers')}}" class="text-muted">Customers</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <span></span>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return `
                    <a href= "${currentLocation}/customers/${data}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details" onclick="event.preventDefault();document.getElementById('send-email-${data}').submit();">
